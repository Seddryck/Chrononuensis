...
---
The command to run Chrononuensis is simply `chrononuensis`. When executing it, you need to provide three required arguments:
...
```bash
chrononuensis -t template.scriban -s data.yaml -o page.html
```
